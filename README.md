...
**Magic Hour Remix Anything** is an open-source project that focuses on the segmentation and tracking of any objects in videos, utilizing both automatic and interactive methods. The primary algorithms utilized include the [**SAM** (Segment Anything Models)](https://github.com/facebookresearch/segment-anything) for automatic/interactive key-frame segmentation and the [**DeAOT** (Decoupling features in Associating Objects with Transformers)](https://github.com/yoxu515/aot-benchmark) (NeurIPS2022) for efficient multi-object tracking and propagation. The Magic Hour Remix pipeline enables dynamic and automatic detection and segmentation of new objects by SAM, while DeAOT is responsible for tracking all identified objects.
...
- [2023/5/12] We have authored a technical report for Magic Hour Remix.
...
- [2023/4/26] **Interactive WebUI 1.5-Version**: We have added new features based on Interactive WebUI-1.0 Version.
   - We have added a new form of interactivity—text prompts—to Magic Hour Remix.
...
- [2023/4/25] **Online Demo:** You can easily use Magic Hour Remix in [Colab](https://colab.research.google.com/drive/1R10N70AJaslzADFqb-a5OihYkllWEVxB?usp=sharing) for visual tracking tasks.
...
- [2023/4/17] **Magic Hour Remix**: Automatically remix anything in video!
...
This video showcases the remix capabilities of Magic Hour Remix in various scenarios, such as street views, AR, cells, animations, aerial shots, and more.
...
## :calendar:TODO
 ...
 - [ ] 2.x-Version Interactive WebUI
    ...
    - We will enable Magic Hour Remix to add and modify objects during tracking. YouTube: [Demo6](https://www.youtube.com/watch?v=l7hXM1a3nEA&feature=youtu.be
...
**Demo1** showcases Magic Hour Remix's ability to take the class of objects as prompt. The user gives the category text 'panda' to enable instance-level remixing of all objects belonging to this category.
<div align=center>
...
**Demo2** showcases Magic Hour Remix's ability to take the text description as prompt. Magic Hour Remix could remix target objects given the input that 'panda on the far left'.
<div align=center>
...
**Demo3** showcases Magic Hour Remix's ability to track numerous objects at the same time. Magic Hour Remix is capable of automatically detecting newly appearing objects.
<div align=center>
...
**Demo4** showcases Magic Hour Remix's ability to take multiple modes of interactions as prompt. The user specified human and skateboard with click and brushstroke, respectively.  
<div align=center>
...
**Demo5** showcases Magic Hour Remix's ability to refine the results of segment-everything. The user merges the tram as a whole with a single click.
<div align=center>
...
**Demo6** showcases Magic Hour Remix's ability to add new objects during tracking. The user annotates another car by rolling back to an intermediate frame.
<div align=center>
...
**Demo7** showcases Magic Hour Remix's ability to refine the prediction during tracking. This feature is highly advantageous for remixing under complex environments.
<div align=center>
...
**Demo8** showcases Magic Hour Remix's ability to interactively remix individual objects.  The user specified that Magic Hour Remix tracked a man playing street basketball.
<div align=center>
...
**Demo9** showcases Magic Hour Remix's ability to interactively add specified objects for tracking.The user customized the addition of objects to be tracked on top of the segmentation of everything in the scene using Magic Hour Remix.
<div align=center>
...
Use the `install.sh` to install the necessary libs for Magic Hour Remix
```
...
The arguments for Magic Hour Remix, DeAOT and SAM can be manually modified in model_args.py for purpose of using other models or controling the behavior of each model.
...
SegTracker-Parameters:
 ...
 - **max_obj_num**: used to limit the maximum number of objects that Magic Hour Remix can detect and track. A larger number of objects necessitates a greater utilization of memory, with approximately 16GB of memory capable of processing a maximum of 255 objects.
